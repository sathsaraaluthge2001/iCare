<html>
    ...
    <body>
        <div class="di1">
            <form method="post" action="addproduct.php" class="fm1" enctype="multipart/form-data">
                ...
                $sql="INSERT INTO `product` (`productid`, `productname`, `productprice`, `productdescription`, `productimage`) VALUES ('".$productid."', '".$productname."', '".$productprice."', '".$productdes."', '".$image."');";
