...
//sql query
$sql="UPDATE `product` SET `productname`='".$productname."',`productprice`='".$productprice."',`productdescription`='".$productdes."',`productimage`='".$image."' WHERE `product`.`productid`='".$productid."';";
